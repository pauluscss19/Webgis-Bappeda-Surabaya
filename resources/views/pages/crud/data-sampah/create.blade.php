...
<head>
  ...
  <title>Tambah Data Sampah - Bappeda Surabaya</title>
      ...
      <div class="crud-container">
        ...
        <div class="crud-header">
          <div class="crud-header__left">
            ...
            <div>
              <h1 class="crud-header__title">Tambah Data Sampah</h1>
              <p class="crud-header__subtitle">Tambahkan data persampahan baru</p>
            </div>
          </div>
        </div>
        ...
        <div class="crud-form-card">
          <form method="POST" action="{{ route('data-sampah.store') }}" id="form-create-sampah">
            @csrf
              ...
              <div class="crud-form__grid">
                <div class="crud-form__group">
                  ...
                  <input type="text" name="kecamatan" class="crud-form__input" 
                         value="{{ old('kecamatan') }}" placeholder="Contoh: Sukolilo" required id="input-kecamatan">
                </div>
                <div class="crud-form__group">
                  <label class="crud-form__label">Kelurahan</label>
                  <input type="text" name="kelurahan" class="crud-form__input" 
                         value="{{ old('kelurahan') }}" placeholder="Contoh: Keputih" id="input-kelurahan">
                </div>
              </div>
            </div>
              ...
              <div class="crud-form__grid">
                <div class="crud-form__group">
                  ...
                  <input type="number" name="volume_sampah_ton" class="crud-form__input" 
                         value="{{ old('volume_sampah_ton', 0) }}" step="0.01" min="0" required id="input-volume">
                </div>
                <div class="crud-form__group">
                  ...
                  <input type="number" name="sampah_terangkut_ton" class="crud-form__input" 
                         value="{{ old('sampah_terangkut_ton', 0) }}" step="0.01" min="0" required id="input-terangkut">
                </div>
                <div class="crud-form__group">
                  ...
                  <input type="number" name="sampah_diolah_ton" class="crud-form__input" 
                         value="{{ old('sampah_diolah_ton', 0) }}" step="0.01" min="0" required id="input-diolah">
                </div>
                <div class="crud-form__group">
                  ...
                  <input type="number" name="sampah_tidak_terkelola_ton" class="crud-form__input" 
                         value="{{ old('sampah_tidak_terkelola_ton', 0) }}" step="0.01" min="0" required id="input-tidak-terkelola">
                </div>
              </div>
            </div>
              ...
              <div class="crud-form__grid--3 crud-form__grid">
                <div class="crud-form__group">
                  ...
                  <input type="number" name="jumlah_tps" class="crud-form__input" 
                         value="{{ old('jumlah_tps', 0) }}" min="0" required id="input-tps">
                </div>
                <div class="crud-form__group">
                  ...
                  <input type="number" name="jumlah_bank_sampah" class="crud-form__input" 
                         value="{{ old('jumlah_bank_sampah', 0) }}" min="0" required id="input-bank-sampah">
                </div>
                <div class="crud-form__group">
              ...
              <div class="crud-form__grid">
                <div class="crud-form__group">
                  ...
                  <input type="text" name="sumber_data" class="crud-form__input" 
                         value="{{ old('sumber_data') }}" placeholder="Contoh: DKRTH Surabaya" id="input-sumber">
                </div>
                <div class="crud-form__group">
            ...
            <div class="crud-form__actions">
              <button type="submit" class="crud-btn crud-btn--success" id="btn-simpan">
