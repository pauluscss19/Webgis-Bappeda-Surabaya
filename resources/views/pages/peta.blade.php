...
<head>
    ...
    <style>
        ...
        .analysis-accordion-header:hover { background: #f1f5f9; }
        .analysis-accordion-header .aa-icon { transition: transform .3s; }
        .analysis-accordion-header.active .aa-icon { transform: rotate(180deg); }
        ...
        .analysis-accordion-body.open { display: block; }
        ...
        #sb-clear:hover { background: #cbd5e1; }
        ...
        #sb-results::-webkit-scrollbar { width: 4px; }
        #sb-results::-webkit-scrollbar-thumb { background: #e2e8f0; border-radius: 4px; }
        ...
        .sb-item:hover, .sb-item:focus { background: #f1f5f9; }
        ...
        .sb-item:hover .sb-item-arrow { color: #3b82f6; }
        ...
        @keyframes sb-ring-anim {
            ...
            70%  { transform: scale(1.5); opacity: .4; }
            ...
            <div id="filter-sidebar">
                ...
                <div id="search-bar-wrapper">
                    <div class="sb-box">
                        ...
                        <input id="sb-input" type="text"
                               placeholder="Cari titik poin berdasarkan nama..."
                ...
                <div class="sidebar-content">
                    ...
                    <div class="layer-group layer-group-persampahan">
                        ...
                        <div class="layer-group-content">
                            ...
                            <label class="layer-item">
                                ...
                                <span class="layer-color" style="background:#8b5cf6; width:20px; height:3px; border-radius:2px;"></span>
                    ...
                    <div class="layer-group layer-group-pompa-saluran">
                        ...
                        <div class="layer-group-content">
                            ...
                            <label class="layer-item">
                                ...
                                <span class="layer-color" style="background:#0284c7; width:20px; height:3px; border-radius:2px;"></span>
                    ...
                    <div class="help-popup-overlay" id="help-popup-rec"
                         onclick="closeHelpIfOutside(event,'rec')">
                    ...
                    {{-- ── Help Popup: Heatmap ── --}}
                    <div class="help-popup-overlay" id="help-popup-heat"
                         onclick="closeHelpIfOutside(event,'heat')">
                        <div class="help-popup">
                            <div class="help-popup-header">
                                <div>
                            ...
                            <div class="help-popup-body">
                                ...
                                <div class="help-section">
                                    ...
                                    <p>Area kelurahan diwarnai berdasarkan jumlah data. Warna gelap = padat, warna terang = sepi.</p>
                                </div>
                                <div class="help-section">
                    ...
                    <div class="fw-section">
                        ...
                        <div class="fw-btn-row">
                            ...
                            <button class="fw-btn-reset" onclick="FilterWilayah.clearFilter()"
                                    title="Reset filter">
                                <i class="bi bi-x-lg"></i>
                            </button>
                        </div>
            ...
            <div id="pdf-overlay" style="
                ...
                <div style="text-align:center; padding:32px 40px; background:#fff;
                    ...
                    <div style="display:flex; justify-content:center; gap:5px; margin-bottom:12px;">
                        <div id="pdf-step-1" style="width:5px; height:5px; border-radius:50%; background:#1e3a8a; transition:all .3s;"></div>
                        <div id="pdf-step-2" style="width:5px; height:5px; border-radius:50%; background:#e2e8f0; transition:all .3s;"></div>
                        <div id="pdf-step-3" style="width:5px; height:5px; border-radius:50%; background:#e2e8f0; transition:all .3s;"></div>
                        <div id="pdf-step-4" style="width:5px; height:5px; border-radius:50%; background:#e2e8f0; transition:all .3s;"></div>
                    </div>
